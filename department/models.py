...
class Department(models.Model):
    ...
    name = models.CharField('学院', max_length=20, primary_key=True)
...
class Office(models.Model):
    ...
    department = models.ForeignKey(Department, on_delete=models.CASCADE,
                                   verbose_name='学院')
    name = models.CharField('教研室', max_length=20, primary_key=True)
...
class Year(models.Model):
    ...
    value = models.DecimalField('年级', max_digits=4, decimal_places=0,
                                primary_key=True)
...
class Major(models.Model):
    ...
    department = models.ForeignKey(Department, on_delete=models.CASCADE,
                                   verbose_name='学院')
    name = models.CharField('专业', max_length=20, primary_key=True)
...
class Manager(models.Model):
    ...
    m_department = models.ForeignKey(Department, verbose_name='学院',
                                     on_delete=models.SET_NULL,
                                     null=True, blank=True)
    m_contact = models.CharField('联系方式', max_length=20, default='无')
...
class Time(models.Model):
    ...
    year = models.ForeignKey(Year, on_delete=models.CASCADE,
                             verbose_name='年级')
    start_time = models.DateTimeField('开放时间', null=True, blank=True)
    end_time = models.DateTimeField('关闭时间', null=True, blank=True)
